  ...
  return (
    <div className='relative mt-35 font-outfit'>
      <div className='relative w-full'>
        ...
        <div className="absolute flex items-center justify-center top-0 right-0 left-0 bottom-0 bg-[#03045E]/60">
          <h3 className='relative z-10 text-3xl font-bold text-white'>About Us</h3>
        </div>
      </div>
      <div className='w-full h-auto py-20 px-30 flex flex-col items-center justify-center gap-20 bg-[#03045E]'>
          <div className='relative flex flex-col items-center gap-10 py-20 text-center justify-center w-220 h-auto border-3 border-[#0077B6] rounded-4xl text-white bg-[#0077B6]/20'>
            <h3 className='text-3xl font-bold'>Who We Are</h3>
            <p className='w-140 text-xl'>Education for Needy People Association (ENPA) is a local charity founded in 2008 and registered in 2010 to support disadvantaged communities. ENPA helps vulnerable children affected by poverty, HIV/AIDS, or loss of family, giving them access to education, safety, and hope.</p>
            <p className='w-140 text-xl'>Based in Yeka Kifle Ketema, northeast of Addis Ababa, ENPA addresses the high cost of schooling and limited health services. We provide education, healthcare support, and help children with disabilities, while empowering single mothers through vocational training to improve their livelihoods.</p><p></p>
            <img src={hands} className='absolute object-cover size-25 top-10 left-10'/>
          </div>
          ...
          <div className='flex items-center justify-center gap-10'>
            <div className='relative bg-[#0077B6]/30 border-2 border-[#90E0EF] rounded-3xl w-90 h-auto'>
          ...
          <div className='w-full h-auto text-white flex flex-col items-center justify-center gap-20 px-30 py-10 bg-gradient-to-br from-green-500/60 to-[#03045E]/70'>
              <h3 className='text-3xl font-bold'>ENPA’s Education and Community Support Programs</h3>
      ...
      <div className='w-full noise-bg h-auto py-25 px-30 flex flex-col items-center justify-center gap-20'>
        ...
        <div className='flex items-center justify-center gap-10'>
          <div className='relative z-20 bg-[#0077B6]/30 border-2 border-[#90E0EF] rounded-3xl w-90 h-auto shadow-xl shadow-[#0077B6]'>
